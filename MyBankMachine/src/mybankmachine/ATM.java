        ...
        while (test != 4) {
            if (test==0) {
                ...
                balance=balance-money;
                                JOptionPane.showMessageDialog(null,"Your new current balance is: $"+balance);
...
System.exit(0);
    ...
    if (intRate >= 0 && numDays >= 0) {
        ...
        JOptionPane.showMessageDialog(null,"The interest earned in " + numDays + " days is: $" + (A - balance));
        balance = A;
    }
    else {
